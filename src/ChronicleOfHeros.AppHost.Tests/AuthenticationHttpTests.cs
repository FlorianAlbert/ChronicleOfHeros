...
#pragma warning disable CA1707 // Identifiers should not contain underscores
    ...
    public async Task Operator_can_enroll_a_player_with_a_temporary_credential_that_requires_replacement()
    {
        ...
        await using (distributedApplication.ConfigureAwait(false))
        {
            ...
            string temporaryOperatorAccessToken = await SignInAndGetAccessTokenAsync(
                apiClient,
            ...
            await ChangePasswordAsync(
                ...
                BootstrapOperatorTestParameters.TemporaryPassword,
                ReplacementPassword);
            TokenPair operatorTokenPair = await SignInAndGetTokenPairAsync(apiClient, ReplacementPassword);
    ...
    public async Task Player_authorization_returns_the_normal_callers_immutable_account_id()
    {
        ...
        await using (distributedApplication.ConfigureAwait(false))
        {
            ...
            string restrictedAccessToken = await SignInAndGetAccessTokenAsync(
                apiClient,
                BootstrapOperatorTestParameters.TemporaryPassword);
